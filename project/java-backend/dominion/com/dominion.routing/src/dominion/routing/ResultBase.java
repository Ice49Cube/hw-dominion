...
{   
     ...
     * to null.
     * @param success Indicates a successful call.
     * @param code The HTTP response code. Which isn't serialized to the client
     *              but used as status code of the HTTP response it's status 
     *              line.
     */
